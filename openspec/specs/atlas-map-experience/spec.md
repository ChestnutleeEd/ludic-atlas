# Atlas Map Experience Specification

## Purpose

Define the explicit deferred boundary and safe resumption contract for a future production Atlas renderer; this capability does not declare Atlas delivered.
