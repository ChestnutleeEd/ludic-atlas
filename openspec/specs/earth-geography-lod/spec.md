# Earth Geography LOD Specification

## Purpose

Define deterministic offline geographic detail levels, renderer-neutral normalization, bounded caching, fallback, and selected-country emphasis for Earth Explorer.
