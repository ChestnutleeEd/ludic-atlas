...
The current Earth experience SHALL provide one consistent country directory, geographic context, country/game details, year and rating filters, cover size, marker view mode, camera mode, rotation, focus, and exit semantics without exposing an unfinished Atlas switch.

#### Scenario: Browse a filtered country
- **WHEN** the user changes filters, focuses a country, and opens a game detail
