...
14. Retro-Futuristic deep-space observatory system for Earth Explorer, including a globe-dominant single-viewport workspace, softened deep navy / cyan / magenta visual hierarchy, an on-demand country drawer and filter tray, Overview / deep Surface camera modes, portrait-aware camera framing, controlled zoom, region and key-country presets, GeoJSON-constrained selected-country markers, truthful aggregation, and mobile three-state bottom-sheet behavior
